...
Sum impacts across all stressor/vulnerability combos, by stressor group.  Manually remove benthic structures - none apparent in the data we have
...
str_gps <- str_gp_df$stressor_group %>% 
  unique()
