...
hab_stressor_df <- tribble(
  ...
  # 'benthic_str',    'benth_str',              'ocean_based', ### manually remove
...
impact_fs <- list.files(here_anx('_output/impact_maps/impact_maps_habitat'),
...
hab_outfile_stem <- here('_output/cumulative_impact_maps/habitat_group_chi_%s.tif')
